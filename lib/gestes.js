...
> d'écrire le verbe.
   ...
   · une ligne par faute : le mot tel qu'il est écrit, une flèche, le mot correct, une
     barre verticale, puis la NATURE en deux ou trois mots (accord sujet-verbe, homophone
     a/à, mot mal su, segmentation, retenue oubliée, énoncé mal lu…). La nature compte
     plus que le nombre : deux copies avec autant de fautes n'appellent pas le même
     travail ;
