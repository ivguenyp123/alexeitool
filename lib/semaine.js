...
/**
 * Les jours de classe. CINQ, pas quatre.
 *
 * Paris a gardé la semaine de quatre jours et demi : le mercredi matin est travaillé, et
 * le mardi comme le vendredi s'arrêtent à 15 heures — l'heure et demie qui suit est du
 * périscolaire, elle n'appartient pas à l'enseignant.
 *
 * Les vingt-quatre heures réglementaires ne bougent pas ; elles se répartissent autrement.
 * Un outil qui supposerait quatre jours de six heures se tromperait sur toute la ville.
 */
