 ...
 *
 * Une fiche de matériel y ajoute son icône et la couleur de sa famille — c'est le bandeau
 * qui la rend reconnaissable dans une pile, et une classe de CE2 n'a pas besoin d'une
 * page austère pour être prise au sérieux.
 */
export const titre = ({ exercice = '', nomDuGeste = '',
                        emoji = '', couleur = '', fond = '' } = {}) => [
  {
    ...
    morceaux: [
      ...(emoji ? [{ texte: `${emoji}\u00A0\u00A0` }] : []),
      ...enMorceaux(exercice || nomDuGeste || 'Correction')
    ]
  }
];
